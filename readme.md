# FEA (Front End Awesome)

#### 说明
记录一些个人看到然后收集的东西，方便以后自己查找


#### 内容

- [使用history模式时， nginx 如何给前端处理](https://molunerfinn.com/fe-be-router-render/)
- [快速编写第三方包 .d.ts 类型声明指南](https://zhuanlan.zhihu.com/p/58123993)
- [leetcode的一些别人的总结](https://github.com/azl397985856/leetcode)
- [node识别图片](https://segmentfault.com/a/1190000015134802)    
- [H5软键盘兼容方案](https://segmentfault.com/a/1190000018959389)
- [准备简历](https://juejin.im/post/5d1d52aff265da1bb2774de0)
